...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('newsletter_subscription', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customauth.MyUser'], null=True, blank=True)),
    ...
    models = {
        ...
        'customauth.myuser': {
            ...
            'coverphoto': ('django.db.models.fields.files.ImageField', [], {'default': "''", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'fb_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'first_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30', 'null': 'True'}),
            'groups': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.Group']", 'symmetrical': 'False', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intro': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            ...
            'nick_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30', 'null': 'True', 'db_index': 'True'}),
            'opt1': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'password': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'photo': ('athumb.fields.ImageWithThumbsField', [], {'default': "''", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'showaddmsg': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'newsletter.subscription': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['customauth.MyUser']", 'null': 'True', 'blank': 'True'})
        },
        'sites.site': {
